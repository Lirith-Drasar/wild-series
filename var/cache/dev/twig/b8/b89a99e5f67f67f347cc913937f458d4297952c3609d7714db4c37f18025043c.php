...
class __TwigTemplate_b8ccd2e7d05f0843ace4626cb42c44f78d08b2d66b6114abb7e6592ea644445f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 32
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 32, $this->source); })()), "synopsis", [], "any", false, false, false, 32), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        // line 39
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_edit", ["slug" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 39, $this->source); })()), "slug", [], "any", false, false, false, 39)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "program/show.html.twig", "/home/lirith-drasar/Bureau/Projet/wild-series/templates/program/show.html.twig");
    }
}

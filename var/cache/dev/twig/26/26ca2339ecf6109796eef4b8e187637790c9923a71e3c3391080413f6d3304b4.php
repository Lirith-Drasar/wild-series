...
class __TwigTemplate_4ba536fb8bb5f5e2d861fad7bc4235f1f6ebb21796465eae85e5caeaaa64023b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["episodes"]) || array_key_exists("episodes", $context) ? $context["episodes"] : (function () { throw new RuntimeError('Variable "episodes" does not exist.', 14, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["episode"]) {
            ...
            <a href=\"\">
                <b>
                    ";
            // line 18
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["episode"], "number", [], "any", false, false, false, 18), "html", null, true);
            echo " / ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["episode"], "title", [], "any", false, false, false, 18), "html", null, true);
            echo "
                </b>
            </a>
            <p>
                ";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["episode"], "synopsis", [], "any", false, false, false, 22), "html", null, true);
            echo "
            </p>
        </li>
    ";
...
";
    ...
    {
        return array (  116 => 26,  106 => 22,  97 => 18,  92 => 15,  88 => 14,  79 => 8,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}", "wild/season.html.twig", "/home/lirith-drasar/Bureau/Projet/wild-series/templates/wild/season.html.twig");
    }
}
